...
- 主事件日：`2026-01-31`，代表 OpenClaw 市場認知擴散的操作性錨點
- 次要事件日：`2025-11-24`，代表 OpenClaw 技術首次公開節點
- 2 週驗證版以主事件日為主，次要事件日僅作輔助穩健性檢查
...
## 5. 資料處理原則
- 事件窗計算預設以 `2026-01-31` 為主；若要比較 `2025-11-24`，應明確標示為輔助檢查結果。
